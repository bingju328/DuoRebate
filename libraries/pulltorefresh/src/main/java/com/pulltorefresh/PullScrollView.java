...
/**
 * Created by bingju on 2016/11/30.
 */
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            default:
                ...
                Log.i(Tag,"ev.getAction: " +ev.getAction());
                if (getScrollY() == 0) {
                    Log.i(Tag,"topMargin():" + headerView.getTopMargin());
...
//                                    ShowUtils.shortShow("更新成功");
    ...
    public void resetHeaderView() {
        ...
        Log.i(Tag,"finalMargin: " + finalMargin);
