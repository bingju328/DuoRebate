...
import com.network.interfaces.CallBackBitmap;
...
//                new OkHttpUrlLoader.Factory(new OkHttpClient()));
    ...
    public static Bitmap getBitmapSync(Context context,String imageUrl) throws ExecutionException, InterruptedException {
