...
public class WheelPicker extends View implements IDebug, IWheelPicker, Runnable {
        ...
        try {
            ...
            for (int drawnDataPos = drawnDataStartPos + mSelectedItemPosition,
                ...
                if (mSelectedItemTextColor != -1) {
                    //计算字体
                    mPaint.setTextSize(adjustTvTextSize(this,data,mItemTextSize));
    ...
    private float adjustTvTextSize(WheelPicker tv, String text,float mItemTextSize) {
        int avaiWidth = tv.getWidth() - tv.getPaddingLeft() - tv.getPaddingRight() - 10;
        ...
        temp.setText(text);
        temp.setTextSize(mItemTextSize);
        TextPaint textPaintClone = new TextPaint(temp.getPaint());
...
//        tv.setTextSize(TypedValue.COMPLEX_UNIT_PX, trySize);
        return trySize< mItemTextSize ? trySize: mItemTextSize;
    }
